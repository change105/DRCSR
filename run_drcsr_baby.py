"""
Run script for DRCSR on the Amazon-Baby dataset.
...
def run(dataset="Baby", saved=True):
    ...
    config_dict = {
        ...
        "comp_tau": 0.4,
        "label_smoothing": 0.0,
        "train_score_temp": 1.0,

        # --- Gated factor memory ---
        "use_mem_gate": True,

        # --- Train-only robust augmentation ---
        "train_aug_noise": 0.03,
        "train_aug_drop": 0.07,

"""
Run script for DRCSR on the Amazon-Sports dataset.

Reproduces the results reported in Table 2 and Table 3 of the paper.

Usage:
    python run_drcsr_sports.py
"""
...
def run(dataset="Sports", saved=True):
